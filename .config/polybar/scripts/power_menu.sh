...
ROFI_OPTIONS=(${ROFI_OPTIONS:--width 11 -me-select-entry 'MouseMiddle' -me-accept-entry 'MousePrimary' -hide-scrollbar -location 1 -yoffset 25 -bw 5 -theme-str 'inputbar { enabled: false; }'})
